...
const ECOSYSTEM = [
  ...
  { name: 'PromptForge', desc: '200+ AI prompts library', href: 'https://promptforge-indol.vercel.app', active: true },
  ...
  { name: 'ScreenForge', desc: 'App Store screenshot generator', href: 'https://screenforge-ten.vercel.app' },
    ...
    <div className="min-h-screen bg-zinc-950">
      <div className="max-w-3xl mx-auto px-6 py-24">
        ...
        <motion.div {...fadeUp} transition={{ delay: 0.1 }} className="mb-16">
          <Link href="/" className="text-sm text-zinc-500 hover:text-white transition-colors mb-8 inline-block">&larr; Back to PromptForge</Link>
          <h1 className="text-4xl font-bold text-white mb-4">About PromptForge</h1>
        ...
        <motion.section {...fadeUp} transition={{ delay: 0.2 }} className="mb-16">
          ...
          <div className="rounded-2xl border border-zinc-800 bg-zinc-900/50 p-8">
            <p className="text-zinc-300 leading-relaxed mb-4">
              AI Business Factory builds developer tools powered by AI. We believe the gap between a mediocre AI output and a production-quality result comes down to the prompt.
            </p>
            <p className="text-zinc-300 leading-relaxed">
              PromptForge curates 200+ battle-tested prompts across 10 categories — from content generation and code writing to data analysis and business strategy. Every prompt is optimized for Claude, GPT-4, and Gemini.
            </p>
          </div>
        </motion.section>
            ...
            {ECOSYSTEM.map((product) => (
              ...
              >
                <div className="flex items-center gap-2 mb-1">
                  ...
                  {product.active && (
                    <span className="text-[10px] px-1.5 py-0.5 rounded-full bg-violet-500/20 text-violet-400">You are here</span>
                  )}
                </div>
