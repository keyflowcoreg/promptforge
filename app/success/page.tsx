    ...
    <div className="min-h-screen bg-zinc-950">
      <div className="max-w-2xl mx-auto px-6 py-24 text-center">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }}>
          ...
          <p className="text-lg text-zinc-400 mb-2">Thank you for purchasing PromptForge Pro Library.</p>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.6 }} className="space-y-4">
          ...
          <div className="rounded-2xl border border-zinc-800 bg-zinc-900/50 p-6 text-left">
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-3 text-sm text-zinc-300">
                ...
                200+ production-grade AI prompts
              </li>
              <li className="flex items-center gap-3 text-sm text-zinc-300">
                <svg className="w-5 h-5 text-emerald-400 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
                10 categories: Content, Code, Business, Data, Creative, Marketing, and more
              </li>
              <li className="flex items-center gap-3 text-sm text-zinc-300">
                <svg className="w-5 h-5 text-emerald-400 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
              ...
              <li className="flex items-center gap-3 text-sm text-zinc-300">
                <svg className="w-5 h-5 text-emerald-400 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
                Downloadable JSON format for easy integration
              </li>
              <li className="flex items-center gap-3 text-sm text-zinc-300">
                <svg className="w-5 h-5 text-emerald-400 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
                Lifetime access with regular new prompt additions
              </li>
            </ul>
          </div>
          ...
          <div className="rounded-2xl border border-zinc-800 bg-zinc-900/50 p-6 text-left">
            ...
            <ol className="space-y-2 text-sm text-zinc-300 list-decimal list-inside">
              <li>Browse the full prompt library in your dashboard</li>
              <li>Filter by category or search for specific use cases</li>
              <li>Copy any prompt and paste it into your AI assistant</li>
              <li>Customize variables to match your exact needs</li>
            </ol>
          </div>
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.8 }} className="mt-12">
          ...
          <div className="flex justify-center gap-3">
            <a href="https://twitter.com/intent/tweet?text=Just%20unlocked%20200%2B%20AI%20prompts%20with%20PromptForge!%20Production-grade%20prompts%20for%20every%20use%20case.&url=https://promptforge-indol.vercel.app" target="_blank" rel="noopener" className="rounded-lg border border-zinc-700 px-4 py-2 text-xs text-zinc-400 hover:text-white hover:border-zinc-500 transition-colors">Share on X</a>
            <a href="https://www.linkedin.com/sharing/share-offsite/?url=https://promptforge-indol.vercel.app" target="_blank" rel="noopener" className="rounded-lg border border-zinc-700 px-4 py-2 text-xs text-zinc-400 hover:text-white hover:border-zinc-500 transition-colors">Share on LinkedIn</a>
          </div>
        </motion.div>
      </div>
